...
const UseCasePage = () => {
  ...
  return (
    <div className="relative flex h-screen flex-col bg-gray-100">
      <nav
        className="bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-stone-700 via-stone-800 to-stone-900 shadow-lg"
            ...
            <div className="flex">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                {navItems.map(({ href, icon: Icon, label }) => (
                  ...
                  >
                    <Icon
                      className="mr-2 h-5 w-5 transition duration-300 group-hover:text-yellow-300"
                      aria-hidden="true"
                    />
